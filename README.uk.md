...
Якщо YouTube не віддає потрібну доріжку, застосунок пропонує локальне розпізнавання відео або вибраного медіафайлу. Whisper визначає мову автоматично; при низькій впевненості застосунок просить її підтвердити. Для роботи потрібні модель faster-whisper, `uv`, `yt-dlp` і `ffmpeg` для аудіофайлів.
